<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="addNew.aspx.cs" Inherits="WebApplication1.WebForm3" %>
...
&nbsp;
        ...
        <tr>
            ...
            &nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="phoneNo" ErrorMessage="Invalid Phone Number" ForeColor="Red" style="font-weight: 700" ValidationExpression="[0-9]+"></asp:RegularExpressionValidator>
            </td>
        </tr>
        <tr>
            ...
            &nbsp;
                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="salary" ErrorMessage="Invalid salary" ForeColor="Red" style="font-weight: 700" ValidationExpression="[0-9]+"></asp:RegularExpressionValidator>
            </td>
        </tr>
        <tr>
